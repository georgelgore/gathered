...
#     imageUrl = card_hash['imageUrl']
#
#     Card.create(name: name, manaCost: manaCost, cmc: cmc, color1: color1, color2: color2, types: types, subtype1: subtype1, subtype2: subtype2, text: text, power: power, toughness: toughness, imageUrl: imageUrl)
#
#   end
#
# end
